...
public class ActBar_AlphaForegroundColorSpan extends ForegroundColorSpan {

    private float mAlpha;

    public ActBar_AlphaForegroundColorSpan(int color) {
        super(color);
	}

    public ActBar_AlphaForegroundColorSpan(Parcel src) {
        super(src);

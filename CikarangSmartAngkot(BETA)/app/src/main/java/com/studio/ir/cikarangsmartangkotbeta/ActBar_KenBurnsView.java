...
public class ActBar_KenBurnsView extends FrameLayout {
    ...
    public ActBar_KenBurnsView(Context context) {
        this(context, null);
    }

    public ActBar_KenBurnsView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ActBar_KenBurnsView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        mImageViews[0] = (ImageView) view.findViewById(R.id.angkots1);
        mImageViews[1] = (ImageView) view.findViewById(R.id.angkots3);
    }
